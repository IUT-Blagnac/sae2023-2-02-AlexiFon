...
int main() {
    ...
    //Resultat doit être : "animal","arbre","et","est","est","chien","chêne","un","un","Le","le"
    char ordre3[] = {'a','n','r','e','c','h','t','i','o','u','s'};
    tailleTest = 11;
    char* result3[tailleTest];
    solution(result3, tailleTest, "Le chêne est un arbre et le chien est un animal", ordre3, 11);
    for (int i = 0; i < tailleTest; i++) {
        printf("%s\n", result3[i]);
    }
